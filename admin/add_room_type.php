...
if(isset($_POST["room_type_name"])){
    ...
    $description = $_POST["description"];
     ...
     if($description === ""){
        $description_err =" Description can't be blanked!";
     }

     if($room_type_name_err == "" && $description_err == ""){
        if(isset($_GET["id"])){
            $room_type = update_room_type($mysqli,$id,$room_type_name);
        ...
        <div class="card-body">
            <form method="post">
                ...
                <div class="form-group"> 
                    ...
                    <textarea type="text" name="description" class="form-control" id="description" value="<?=$description ?>" placeholder="Enter Description "></textarea>
                    ...
                    <table class="table table-bordered  table-striped">
                        ...
                        <tbody> 
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="./add_room_type.php?id=<?=$room_type['id']?>" class="btn btn-sm btn-success"><i class="fa fa-pen"></i></a>
