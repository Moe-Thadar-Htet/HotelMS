...
if(isset($_POST["customer_name"])){
    ...
    $checkout = $_POST["checkout"];
     ...
     if($invalid){
        if(isset($_GET["editId"])){
            $update =update_customer($mysqli,$editId,$customer_name,$nrc,$phone_no,$email,$checkin,$checkout);
            if($update){
                echo "<script>location.replace('./add_customer.php')</script>";
            }
        }else{
            if(add_customer($mysqli,$customer_name,$nrc,$phone_no,$email,$checkin,$checkout)){
                echo "<script>location.replace('./add_customer.php')</script>";
            }else{
                $invalid = true;
            }      
